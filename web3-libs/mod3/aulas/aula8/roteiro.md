...
- [Enviando um Struct para o contrato](../playground/aula8/structs.py)
...
- [Enviando um Enum para o contrato](../playground/aula8/enum.py)
...
- [Enviando um Array para o contrato](../playground/aula8/array.py)
